...
class YIT_CPT_Unlimited {     
	...
	public function init() {
	     ...
	     add_image_size( 'admin-post-type-thumbnails', 140, 100, true );
    ...
    public function add( $post_type, $args = array() ) {
        ...
        if ( isset( $args['settings_item_custom'] ) ) { 
            $args['settings_item'] = array_merge_recursive( $args['settings_item'], $args['settings_item_custom'] );
    ...
    */
    ...
    protected function _settingsOption( $option, $item_id = 0 ) {
        ...
        ?><div class="the-metabox <?php echo $option['type'] ?> clearfix"><?php
