                ...
                {                          
                    ...
                    echo '<li>';
                        echo '<div>';
                            ...
                            $website = "<a class='url-testimonial' href=\"" . esc_url( $website ) . "\">". ( !empty( $label ) ? $label : $website )  ."</a>";
                            
                            the_post_thumbnail( 'thumb-testimonial', array( 'class' => 'thumbnail' ) );
                            the_title( '<div class="name-testimonial"><a class="name-testimonial" href="' . get_permalink( get_the_ID() ) . '">', '</a><br />' . $website . '</div>' );
