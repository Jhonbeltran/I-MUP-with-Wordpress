...
$comment_args = array(
	...
	'comment_field'        => '<p class="comment-form-comment span' . ( yit_get_sidebar_layout() == 'sidebar-no' ? 12 : 9 ) . '"><label for="comment">'. __( 'Your comment', 'yit' ).'</label><i class="icon-pencil"></i><textarea id="comment" name="comment" cols="45" rows="8"></textarea></p><div class="clear"></div>',
	...
	'comment_notes_after'  => '<div class="span' . ( yit_get_sidebar_layout() == 'sidebar-no' ? 12 : 9 ) . '">', // Hanlde #respond #submit span
	'id_form'              => 'commentform',
	'id_submit'            => 'submit',
